      ...
      >
        ...
        >
          <label className="flex flex-col">
            <span className="etxt-white font-medium mb-4">
              Your Name
            </span>
            <input
              type="name"
              ...
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rough-lg outline-none border-none font-medium"
            />
          </label>
          <label className="flex flex-col">
            <span className="etxt-white font-medium mb-4">
